...
export const Metamask = () => {
    return(
        <main>
            <div className="title">
                <div className="logo">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="50" height="44" /* viewBox="0 0 24px 24px" */>
                        <path fill="#E17726" stroke="#E17726" stroke-linecap="round" stroke-linejoin="round" stroke-width=".25" d="M32.96 1l-13.14 9.72 2.45-5.73L32.96 1z"></path><path fill="#E27625" stroke="#E27625" stroke-linecap="round" stroke-linejoin="round" stroke-width=".25" d="M2.66 1l13.02 9.8L13.35 5 2.66 1zm25.57 22.53l-3.5 5.34 7.49 2.06 2.14-7.28-6.13-.12zm-26.96.12l2.13 7.28 7.47-2.06-3.48-5.34-6.12.12z"></path>
            ...
            <p>In order to use the decentralized application you are required to have <a rel="noreferrer" target="_blank" href="https://metamask.io/">Metamask</a>  installed in your browser.</p>
